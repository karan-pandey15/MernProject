          ...
          <tbody>
            {data.map((food, index) => {
              return (
                ...
                <td ><button type="button" className="btn p-0"><i  onClick={() => { dispatch({ type: "REMOVE", index: index }) }} /></button> </td>
                  </td>

                  <td><button type="button" className="btn p-0">
                  <i class="fa fa-trash dekh text-white" onClick={() => { dispatch({ type: "REMOVE", index: index }) }}></i>
                  </button></td>
